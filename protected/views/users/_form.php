...
<div class="bg-gray-900 p-6 rounded-lg shadow-md max-w-2xl mx-auto">
    ...
    <!-- Password -->
    <div>
        <?php echo $form->labelEx($model, 'password_hash', ['class' => 'block text-gray-300 mb-1 font-semibold']); ?>
        ...
        <?php echo $form->error($model, 'password_hash', ['class' => 'text-red-500 text-sm mt-1']); ?>
    </div>
